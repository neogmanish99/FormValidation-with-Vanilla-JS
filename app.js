...
const res = document.getElementById('resetF');
...
function validateForm(e) {
    ...
    let govID = document.forms['myForm']['id'].value;
    if(govID.length<1){
    ...
    let requests = document.forms['myForm']['requests'].value;
    if(requests.length<10){
        setError('request','Paragraph should contain at least 10 characters')
    }else{
        setError('request','')
    }
